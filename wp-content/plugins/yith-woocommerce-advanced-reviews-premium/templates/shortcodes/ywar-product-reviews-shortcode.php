 ...
 *
 * Adds an action in the review shortcode template before any content.
 */
do_action( 'ywar_init_product_reviews_template' );
 ...
 *
 * Adds an action in the review shortcode template before the reviews.
 *
...
<div id="reviews" class="ywar-review-content">
	 ...
	 *
	 * Adds an action in the review shortcode template inside main content div.
	 */
	do_action( 'yith_advanced_reviews_review_container_start' );
	?>
	<div id="comments">
		...
		<?php if ( $reviews_count ) : ?>
			 ...
			 *
			 * Adds an action in the review shortcode template before review list.
			 *
			 ...
			 *
			 * Adds an action in the review shortcode template after review list.
			 *
			 * @param obj $product Obj of the product.
			 */
	...
	<div
		...
		<div id="review_form">
			...
			$comment_form = array(
				...
				'comment_notes_after'  => '',
				'fields'               => array(
					/** APPLY_FILTER: yith_ywar_name_field_label
					*
			...
			/** APPLY_FILTER: woocommerce_product_review_comment_form_args
			*
	...
	<?php if ( ! $can_submit ) : ?>
		...
		<?php
			/** APPLY_FILTER: ywar_product_reviews_submit_reviews_denied_text
			 *
